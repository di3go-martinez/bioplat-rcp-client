...
public abstract class EJob extends Job {
	...
	/**
	 * Método principal del job, corre en el thread que se abre para la
	 ...
	 * vista directamente, en caso de ser necesario, ver: {@link ThreadUIUtils}
	 * </b>
	 * 
	 * @param monitor
	 */
	...
	/**
	 * Determina si la barra de progreso está modal o no, lo cual significa que
	 * el job se mando a segundo plano
	 * 
	...
	/**
	 * Si el procesamiento <code>doWork</code> terminó e isModal == true, se
