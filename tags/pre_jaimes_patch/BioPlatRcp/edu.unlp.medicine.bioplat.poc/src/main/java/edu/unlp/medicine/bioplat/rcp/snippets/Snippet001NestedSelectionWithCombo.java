...
public class Snippet001NestedSelectionWithCombo {
	...
	static class View {
		...
		public Shell createShell() {
			...
			IObservableMap attributeMap = BeansObservables.observeMap(Observables.staticObservableSet(realm, new HashSet(viewModel.getPeople())), Person.class, "name");
			...
			dbc.bindValue(SWTObservables.observeText(name, SWT.Modify), BeansObservables.observeDetailValue(selectedPerson, "name", String.class));
			...
			dbc.bindValue(citySelection, BeansObservables.observeDetailValue(selectedPerson, "city", String.class));
