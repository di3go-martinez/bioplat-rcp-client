...
public class Snippet014WizardDialog {
	...
	static class FirstWizardPage extends WizardPage {
		...
		public void createControl(Composite parent) {
			...
			dbc.bindValue(SWTObservables.observeText(text, SWT.Modify), //
					...
					new UpdateValueStrategy().setAfterConvertValidator(new SingleDigitValidator()), null);
	...
	static class SecondWizardPage extends WizardPage {
		...
		public void createControl(Composite parent) {
			...
			dbc.bindValue(SWTObservables.observeText(text, SWT.Modify), ((SampleWizard) getWizard()).getModel().dateValue);
