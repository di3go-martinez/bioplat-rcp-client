 ...
 * 
 */
public class CopyTextColumnMenuItemDescriptor implements MenuItemDescriptor {
	...
	public CopyTextColumnMenuItemDescriptor(CopyTextMenuItemProvider provider) {
		...
		mic.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				for (Object item : tableItems)
					values.add(accesor.get(item).toString());
