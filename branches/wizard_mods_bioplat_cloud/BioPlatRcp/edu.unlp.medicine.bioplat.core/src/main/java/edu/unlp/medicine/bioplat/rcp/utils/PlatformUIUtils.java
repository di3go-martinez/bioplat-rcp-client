...
public class PlatformUIUtils {
	...
	public static IEditorPart openEditor(final Object o, final String id) {
		return runinui(new Callable<IEditorPart>() {
	...
	public static <T> T runinui(final Callable<T> uicompatible) {
	 ...
	 * 
	 * @param viewId
	 * @return retorna la vista o null si la misma no se encuentra o está cerrada.
	 */
	...
	/**
	 * Busca la imagen imagename. Las imagenes se cachean para agilizar futuros. Se
	 * crean utilizando un descriptor de imagen generado por el Activator del plugin
	 * usos
	 * 
	 * @param imagename
	 * @return
