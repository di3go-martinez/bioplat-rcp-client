...
public class LongRankGUIMaker extends GuiMaker {
	...
	public LongRankGUIMaker(TableReferenceProvider2 provider, LongRankTestHelper helper, List<ExperimentAppliedToAMetasignature> list) {
		this.helper = helper;
